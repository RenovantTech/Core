 ...
 */
class CryptoCookie {
	public const KEY_FILE = DATA_DIR . 'cookie.key';
	 ...
	 * @throws \Exception
	 */
	public function __construct(string $name, int $expire = 0, string $path = '', ?string $domain = '', bool $secure = true, bool $httpOnly = false, string $sameSite = 'Lax') {
		$this->name     = $name;
		$this->expire   = $expire;
		$this->path     = $path;
