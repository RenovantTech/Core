...
class PDO extends \PDO {
	 ...
	 */
	public static function trace(string $id, int $level, string $statement, ?array $params = null) {
		if (!empty($params)) {
			$keys = $values = [];
	 ...
	 */
	public function __construct(string $dsn, ?string $username = null, ?string $password = null, ?array $options = null, string $id = 'master') {
		$this->_id = $id;
