...
class ArraySql {
	...
	public function criteriaExp($criteriaExp = null) {
	...
	public function orderExp($orderExp = null) {
		if (empty($orderExp)) {
			return $this;
		}
		...
		switch (count($expArray)) {
			case 1: array_multisort($indexes[0], $sorts[0], $this->data);
				break;
			case 2: array_multisort($indexes[0], $sorts[0], $indexes[1], $sorts[1], $this->data);
				break;
			case 3: array_multisort($indexes[0], $sorts[0], $indexes[1], $sorts[1], $indexes[2], $sorts[2], $this->data);
				break;
			case 4: array_multisort($indexes[0], $sorts[0], $indexes[1], $sorts[1], $indexes[2], $sorts[2], $indexes[3], $sorts[3], $this->data);
				break;
		}
		return $this;
	}

	public function page($page = null, $pageSize = null) {
