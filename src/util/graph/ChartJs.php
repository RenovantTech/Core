...
use renovant\core\util\DatePeriod;
...
class ChartJs {
	...
	public function __construct(string $table, ?string $fields = null, ?string $pdo = null) {
		$this->Query = new Query($table, $fields, $pdo);
	}

	public function fetch(string $criteria, array $params, string $interval, string $from, string $to, array $dataFn): array {
