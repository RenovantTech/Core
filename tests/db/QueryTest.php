...
class QueryTest extends \PHPUnit\Framework\TestCase {
	...
	public function testExecCount() {
		...
		// GROUP BY
		$Query = (new Query('people', null, 'mysql'))->groupBy('age');
	...
	public function testExecInsertException() {
		try {
			$Query = (new Query('sales', null, 'mysql'));
	...
	public function testExecInsertUpdate() {
		$Query = (new Query('people', null, 'mysql'));
	...
	public function testCriteriaExp() {
		// EQ
	...
	public function testSetCriteriaDictionary() {
		$dictionary = [
			'ageGTE'       => 'age >= ?1',
	...
	public function testSetOrderByDictionary() {
		$dictionary = [
