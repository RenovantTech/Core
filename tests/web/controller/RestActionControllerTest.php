...
class RestActionControllerTest extends \PHPUnit_Framework_TestCase {
	...
	function testConstructor() {
		$ActionController = new \mock\web\controller\RestActionController;
		$this->assertInstanceOf('metadigit\core\web\ControllerInterface', $ActionController);
		$this->assertInstanceOf('metadigit\core\web\controller\ActionController', $ActionController);

		$ReflProp = new \ReflectionProperty('metadigit\core\web\controller\ActionController', '_actions');
	 ...
	 */
	function testResolveActionMethod(\mock\web\controller\RestActionController $ActionController) {
		$ReflMethod = new \ReflectionMethod('metadigit\core\web\controller\ActionController', 'resolveActionMethod');
	...
	function testResolveActionException() {
		$ActionController2 = new \mock\web\controller\RestActionController;
		$ReflMethod = new \ReflectionMethod('metadigit\core\web\controller\ActionController', 'resolveActionMethod');
		$ReflMethod->setAccessible(true);
	 ...
	 * @depends testResolveActionMethod
	 */
	function testHandle(\mock\web\controller\RestActionController $ActionController) {
		$_SERVER['REQUEST_URI'] = '/book';
		$_SERVER['REQUEST_METHOD'] = 'POST';
		$_POST = ['id'=>53];
		$Req = new Request;
