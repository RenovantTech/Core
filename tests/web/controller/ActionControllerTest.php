...
class ActionControllerTest extends \PHPUnit\Framework\TestCase {
	 ...
	 */
	function testResolveActionMethod(\mock\web\controller\ActionController $ActionController) {
	...
	function testResolveActionException() {
		$ActionController2 = new \mock\web\controller\ActionController;
		$ReflMethod = new \ReflectionMethod('metadigit\core\web\controller\ActionController', 'resolveActionMethod');
		$ReflMethod->setAccessible(true);
	 ...
	 * @depends testResolveActionMethod
	 */
	function testHandle(\mock\web\controller\ActionController $ActionController) {
